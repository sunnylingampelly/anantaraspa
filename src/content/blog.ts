...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "Post-2021, hygiene has rightly become a non-negotiable filter for choosing a spa. Ask whether tools and surfaces are sanitised between sessions, whether linens are single-use, and whether rooms are reset — not just tidied — between guests. At Anantara Spa, every private suite is cleaned and reset after each appointment, and our therapists follow premium hygiene protocols as standard, not as an upsell.",
  ...
  },
  {
    ...
    content: [
      ...
      "Every session at Anantara Spa begins with a short consultation precisely for this reason. Tell your therapist how you're feeling — tense, fatigued, stressed, stiff — and they'll recommend the right therapy, or a combination, on the spot.",
  ...
  },
  {
    ...
    content: [
      "A large share of our guests at Anantara Spa work within a short drive of Gachibowli — HITEC City, the Financial District, Wipro Circle, Mindspace, and the DLF campuses. And a specific pattern shows up in what they book: deep tissue massage, consistently, more than any other single therapy.",
  ...
  },
  {
    ...
    content: [
      ...
      "Not every listing that advertises a couple massage actually offers a private room for two. At Anantara Spa, our couples suite is a single enclosed room with two treatment tables and two dedicated therapists working simultaneously — not two separate rooms, and not a shared open bay.",
