...
export const areas: Area[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Anantara Spa is a short walk or ride from Raidurg Metro Station — an easy stop on the way home.",
    intro:
      "For guests commuting via the Metro, Anantara Spa is easily reached from Raidurg Metro Station — a convenient stop before heading home rather than a special trip. It's a favourite among Metro commuters looking to unwind after a long day without adding much to the journey.",
  ...
  },
  {
    ...
    intro:
      "Guests working out of Mindspace regularly choose Anantara Spa as their go-to reset, usually reaching us in under 15–20 minutes by car depending on traffic. We combine hotel-spa-level privacy and hygiene standards with accessible pricing, so proper recovery doesn't have to wait for a special occasion.",
